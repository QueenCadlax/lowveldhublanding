...
export const metadata: Metadata = {
  title: "Cybersecurity & Data Protection | Lowveld Hub",
  description: "Security architecture, access controls, threat monitoring and data protection to safeguard your business.",
}
  ...
  return (
    <main className="relative overflow-x-hidden">
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-8">
            ...
            <p className="mt-6 max-w-3xl text-lg leading-relaxed text-muted-foreground">
              Security architecture, access controls, threat monitoring and data protection designed to safeguard your business. We protect what matters.
            </p>
      ...
      <section className="relative px-4 py-16 sm:px-6 lg:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="mb-12">
            <h2 className="text-3xl font-semibold tracking-tight sm:text-4xl">What We Protect</h2>
            <p className="mt-2 text-muted-foreground">Comprehensive security solutions for modern threats.</p>
          </div>
      ...
      <section className="relative px-4 py-16 sm:px-6 lg:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="mb-12">
            ...
            <p className="mt-2 text-muted-foreground">Security experts who understand your business and industry.</p>
          </div>

          <div className="grid gap-6 sm:grid-cols-2">
            {[
              { title: "Expert Team", desc: "Certified security professionals with years of experience." },
              { title: "Proactive", desc: "We prevent attacks before they happen." },
              { title: "Compliance Ready", desc: "Built to meet regulatory requirements." },
              { title: "Real-Time Protection", desc: "24/7 monitoring and threat detection." },
              { title: "Best Practices", desc: "Industry standards and proven methodologies." },
              { title: "Ongoing Support", desc: "Continuous updates and security improvements." },
            ].map((item) => (
      ...
      <section className="relative px-4 py-16 sm:px-6 lg:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="mb-12">
            <h2 className="text-3xl font-semibold tracking-tight sm:text-4xl">Our Security Process</h2>
          </div>

          <div className="flex flex-wrap gap-4 md:gap-2 justify-between items-center">
            {["01 Assess", "02 Design", "03 Implement", "04 Monitor", "05 Improve"].map((step, i) => (
