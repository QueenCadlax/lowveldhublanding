...
export const metadata: Metadata = {
  title: "Cloud & Infrastructure | Lowveld Hub",
  description: "Scalable cloud architecture, deployments, integrations and infrastructure built for reliability.",
}
        ...
        <div className="mx-auto max-w-5xl">
          ...
          <div className="mt-8">
            ...
            <p className="mt-6 max-w-3xl text-lg leading-relaxed text-muted-foreground">
              Scalable cloud architecture, deployments, integrations and infrastructure built for reliability. We design systems that grow with your business without breaking.
            </p>
      ...
      <section className="relative px-4 py-16 sm:px-6 lg:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="mb-12">
            ...
            <p className="mt-2 text-muted-foreground">Cloud solutions designed for your specific needs.</p>
          </div>
      ...
      <section className="relative px-4 py-16 sm:px-6 lg:py-20">
        <div className="mx-auto max-w-5xl">
          <div className="mb-12">
            ...
            <p className="mt-2 text-muted-foreground">We build cloud solutions that are reliable, cost-effective, and future-ready.</p>
          </div>

          <div className="grid gap-6 sm:grid-cols-2">
            {[
              { title: "Scalable", desc: "Architecture designed to handle growth without compromise." },
              { title: "Reliable", desc: "99.9%+ uptime with redundancy and failover built-in." },
              { title: "Secure", desc: "Enterprise-grade security across all layers." },
              { title: "Cost Effective", desc: "Optimized to reduce cloud costs without sacrificing performance." },
              { title: "Multi-Cloud", desc: "Work with AWS, Azure, GCP or a hybrid approach." },
              { title: "DevOps Ready", desc: "Automated deployment, testing and monitoring." },
            ].map((item) => (
      ...
      <section className="relative px-4 py-16 sm:px-6 lg:py-20">
        <div className="mx-auto max-w-5xl">
          ...
          <div className="flex flex-wrap gap-4 md:gap-2 justify-between items-center">
            {["01 Assess", "02 Design", "03 Deploy", "04 Optimize", "05 Support"].map((step, i) => (
